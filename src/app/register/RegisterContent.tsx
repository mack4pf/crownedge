                    ...
                    <div className="space-y-4 px-1">
                        <div className="flex items-start gap-3">
                            ...
                            <label htmlFor="terms" className="text-xs font-medium text-zinc-500 leading-relaxed cursor-pointer">
                                I confirm that I am a professional trader and I agree to the <Link href="/company" className="text-brand-gold font-bold">Terms of Use</Link> and <Link href="/company" className="text-brand-gold font-bold">Risk Disclosure</Link>.
                            </label>
                        </div>
                    </div>
