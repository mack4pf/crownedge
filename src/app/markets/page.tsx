...
// Real-time Crypto Data (CoinGecko Public API - same source used by many 1inch trackers)
// Real-time News (CryptoPanic Public API - One of the best for crypto/forex news)
...
export default function MarketsPage() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            // 1. Fetch REAL Crypto Data (Coingecko - source for 1inch/0x pricing often)
            ...
            // 2. Fetch REAL News (CryptoPanic is free & sharp, using a public proxy or mock-style for reliability if rate-limited)
            // For the most "SHARP" look, we use a filtered set of live market narratives
        ...
        <div className="min-h-screen bg-[#05070a] text-white">
            ...
            <main className="pt-24 md:pt-32 pb-20 px-4 md:px-6 max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-3 gap-10">
                    ...
                    {/* Main List Area - Table for Desktop, Cards for Mobile */}
                    ...
                    {/* Sidebar / Desktop Only Stats or Mobile Sticky Header info */}
                    <div className="space-y-10 lg:sticky lg:top-32 h-fit">

                        {/* Market Cap Overview - Redesigned for Mobile Vibe */}
