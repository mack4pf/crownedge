            ...
            <div className="max-w-7xl mx-auto text-center lg:text-left grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                        <Link href="/register" className="gold-button px-10 py-5 rounded-2xl text-lg flex items-center justify-center gap-3 group shadow-2xl shadow-brand-gold/20">
                            Start Trading <ArrowRight size={22} className="group-hover:translate-x-1.5 transition-transform" />
                        </Link>
                        <Link href="/markets" className="glass px-10 py-5 rounded-2xl text-lg font-bold hover:bg-white/10 transition-all flex items-center justify-center gap-3">
                ...
                >
                    ...
                    <div className="glass rounded-[48px] p-2 border-[var(--border)] shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-700 overflow-hidden">
                        <div className="bg-[var(--card-bg)] rounded-[40px] p-8 border border-[var(--border)]">
                            ...
                            <div className="space-y-6">
                                <div className="h-40 bg-[var(--hover-bg)] rounded-3xl border border-[var(--border)] flex items-end p-4 gap-2">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="h-24 bg-brand-blue/10 rounded-3xl border border-brand-blue/20 p-4">
                                        ...
                                        <p className="text-xl font-black text-foreground"><span className="text-green-500 ">+</span>$102,492</p>
                                    </div>
                                    <div className="h-24 bg-brand-blue/10 rounded-3xl border border-brand-blue/20 p-4">
                                        <p className="text-[10px] font-bold text-zinc-500 uppercase mb-1">Loss</p>
                                        <p className="text-xl font-black text-foreground"><span className="text-red-500 ">-</span>$492</p>
                                    </div>
                                    <div className="h-24 bg-brand-purple/10 rounded-3xl border border-brand-purple/20 p-4">
